...
async function openPatient(id){
  ...
  const[daily,meds,fu,msgs,setts,protos,imports,intakes,reports]=await Promise.all([
  ...
  const readErrors={summary:daily.error,therapy:meds.error,controls:fu.error,chat:msgs.error,patientimports:imports.error,reports:reports.error,settings:setts.error||protos.error};
